...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    if predators:
        ...
        # Sprinting decision: sprint whenever predator <= 55u and energy > 18
        if nearest_pred_dist <= 55.0 and energy > 18.0:
    ...
    # 2. Fruit Harvesting (Nearest fruit)
    elif fruits:
    ...
    # 3. Tree Cluster Centroid Foraging & Fruit Spawning Hotspots
        ...
        if count >= 2:
            # Head toward the center-of-mass of the tree cluster
    ...
    # Cost: 100. Require energy >= 185.0 so parent keeps >= 85 energy.
