...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    if predators:
        ...
        # Wall-bounce check: if escaping towards a close edge, deflect angle
        ...
        # Sprinting decision: sprint whenever predator is within 55 units and energy is sufficient
    ...
    # 5. Safe Parent Energy Reserve Reproduction Strategy
    # Cost: 100. Spawn when energy >= 190.0 so parent keeps >= 90 energy!
