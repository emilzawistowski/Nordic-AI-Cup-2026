...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    # 4. ECONOMICAL WANDERING (Smoother straight trajectories)
    else:
        ...
        turn_angle = 0.025 * math.sin(age * 0.06 + phase)
