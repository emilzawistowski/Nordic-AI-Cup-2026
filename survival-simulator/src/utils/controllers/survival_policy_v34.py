...
- Wandering: Introduce agent-specific frequency modulations to ensure agents explore distinct sectors of the map when searching for fruit/trees:
    ...
    faster_wave = math.sin(age * (0.015 + (agent_id % 3) * 0.002) + phase * 0.7)
"""
...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    # 4. ECONOMICAL WANDERING (Phase-Shifted Frequencies per Agent ID)
    else:
