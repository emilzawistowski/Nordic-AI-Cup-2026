...
def weighted_escape_direction(predators: list, agent_id: int) -> float:
    ...
    for predator in predators:
        ...
        # Micro tangential offset (0.15 rad ≈ 8.5 degrees) at 45-70u
        if 45.0 <= distance <= 70.0:
            tangent_side = 0.15 if agent_id % 2 == 0 else -0.15
...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    # 5. Reproduction (v11 champion threshold)
