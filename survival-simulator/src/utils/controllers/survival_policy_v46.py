...
In v46:
- Maintain exact v11 movement, fleeing, sprinting, and reproduction.
- Improve tree observation selection:
  If multiple trees are visible, prefer the NEAREST mature tree (dist < 200) over young trees.
  If an agent is near a mature tree, circle around it at radius 25u to catch newly spawned fruits.
"""
...
def action_decision(observation_response: dict, rng: random.Random) -> ActionRequest:
    ...
    # 3. Tree Orbiting Foraging (Enhanced)
        ...
        if tree_dist > 35.0:
            ...
            # Orbit tree closely (25u radius) to catch fresh fruit drops
